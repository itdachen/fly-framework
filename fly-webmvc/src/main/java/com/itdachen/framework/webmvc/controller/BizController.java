package com.itdachen.framework.webmvc.controller;

import com.itdachen.framework.context.annotation.Log;
import com.itdachen.framework.core.biz.BizQuery;
import com.itdachen.framework.core.constants.LogType;
...
import com.itdachen.framework.webmvc.utils.StringEscapeEditor;
...
public class BizController<BizService extends IBizService<T, V, Q, PK>, T, V, Q extends BizQuery, PK> {
     ...
     *
     * @param params 分页查询参数
     * @return com.itdachen.framework.core.response.ServerResponse<com.itdachen.framework.core.response.TableData < V>>
     * @throws BizException
     */
     ...
     * @return com.itdachen.framework.core.response.ServerResponse<T>
     * @throws BizException
     */
    @PostMapping(value = "")
    @ResponseBody
     ...
     *
     * @param id 需要查询数据的id
     * @return com.itdachen.framework.core.response.ServerResponse<V>
     * @throws BizException
     */
    @GetMapping(value = "/{id}")
    @ResponseBody
     ...
     *
     * @param id 需要删除数据的id
     * @return com.itdachen.framework.core.response.ServerResponse<Integer>
     * @throws BizException
     */

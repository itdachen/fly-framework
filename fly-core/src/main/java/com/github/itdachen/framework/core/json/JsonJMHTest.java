...
public class JsonJMHTest {
    ...
    private final static String json = "{\"id\":122345667,\"email\":\"jianzh5@163.com\",\"price\":12.25}";
    //  private final static  UserEntity userEntity = new UserEntity(13345L, "jianzh5@163.com", BigDecimal.valueOf(12.25));

...
public class TokenUtil {
     ...
     */
    private final static String SECRET = "secretK321445658654232413125478653242346582454ey";
    /**
     * 秘钥实例
     */
    ...
    public static void main(String[] args) {
        String s = genAccessToken("itdachen");
        System.err.println(s);

        Jws<Claims> claimsJws = parseClaim(s);
        System.err.println(claimsJws);

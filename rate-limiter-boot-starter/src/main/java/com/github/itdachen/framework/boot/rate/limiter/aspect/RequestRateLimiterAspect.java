package com.github.itdachen.framework.boot.rate.limiter.aspect;

import com.github.itdachen.framework.boot.rate.limiter.annotation.RequestRateLimiter;
...
public class RequestRateLimiterAspect {
    ...
    @Around("@annotation(com.github.itdachen.framework.boot.rate.limiter.annotation.RequestRateLimiter)")

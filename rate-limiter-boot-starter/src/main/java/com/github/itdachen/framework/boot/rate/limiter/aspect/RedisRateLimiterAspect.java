...
import com.github.itdachen.framework.boot.rate.limiter.annotation.RedisRateLimiter;
...
public class RedisRateLimiterAspect {
    ...
    @Around("@annotation(com.github.itdachen.framework.boot.rate.limiter.annotation.RedisRateLimiter)")
